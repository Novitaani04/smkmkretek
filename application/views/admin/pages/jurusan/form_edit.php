...
<input type="number" name="id_jurusan"class="form-control" value="<?=$data_jurusan->id_jurusan?>" hidden>  
            ...
            <div class="mb-3">
                <!-- <input type="number" class="form-control" name="id_jurusan"value="" id="inputid_jurusan"> -->
            </div>
            <div class="mb-3">
            ...
            <label for="inputdeskripsi" class="form-label">Deskripsi</label>
                <input type="text" class="form-control" name="deskripsi"value="<?=$data_jurusan->deskripsi?>"id="inputdeskripsi">
            </div> 
