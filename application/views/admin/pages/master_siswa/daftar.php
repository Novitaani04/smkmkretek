...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <a href="<?=base_url('admin/MasterSiswa/form_add')?>"class="btn btn-primary mt-3"><i class="fa fa-plus"></i>Tambah data baru</a>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?=base_url('admin/MasterSiswa/hapus/') .$row->nik ?>" class="btn btn-danger"onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Hapus</a>
                        </td>   
                    </tr>
                   <?php endforeach; ?>
                    </tbody>
