        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('admin/MasterSiswa')?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Master Siswa</span></a>
            </li>
            <!-- Nav Item - Master Siswa -->
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('admin/MasterAlumni')?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Master Alumni</span></a>
            </li>
            <!-- Nav Item - Master Siswa -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Master Siswa -->
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('admin/Extrakurikuler')?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Extrakurikuler</span></a>
            </li>
            <!-- Nav Item - Master Siswa -->
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('admin/Organisasi')?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
